...
$a = strtolower('Update Data KKN di E-learning');
$jawaba = 'Mohon mengirimkan foto *KTP/KTM* saudara

*Mohon informasi Kelompok KKN berapa?*
*Mohon menunggu jawaban, agar dapat segera diproses*';

$b = strtolower('Laporan Harian');
$jawabb = 'Untuk proses, mohon melengkapi data berikut:

1. *Foto KTP/KTM* 
2. *Foto Kendala di sistem*
