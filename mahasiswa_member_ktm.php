...
$a = strtolower('KTM Hilang');
$jawaba = '*Info dari akademik untuk permintaan kehilangan KTM:*
1. Surat ket kehilangan KTM dari Fakultas via online (cek laman web fakultas)
2. Mengirimkan surat tersebut ke bagian Akademik & Kemahasiswaa via WA (bapak Fadhol +62 821-3385-6036 atau bapak Priswanto Teguh +62 857-2711-2777)
3. Bagian akademik menerbitkan KTM Digital dalam bentuk Pdf.';

$b = strtolower('KTM Sementara');
$jawabb = '*Info dari akademik untuk permintaan KTMS:*
1. Bagi mahasiswa baru yang membutuhkan KTMS dapat menghubungi Bagian Akademik & Kemahasiswaan via WA (bapak Fadhol +62 821-3385-6036 atau bapak Priswanto Teguh +62 857-2711-2777) dengan menyebutkan 
*NIM dan Nama & Bukti pembayaran UKT.*';
