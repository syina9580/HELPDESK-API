...
1. Foto KTP/KARTU PEGAWAI

*Mohon menunggu jawaban, agar dapat segera diproses*';

$b = strtolower('Data Tidak Sesuai');
...
$c = strtolower('Hapus Jurnal');
$jawabc = 'Untuk proses, mohon melengkapi data berikut:
1. *Foto KTP/KARTU PEGAWAI* 

Mohon diisi terlebih dahulu data dibawah ini untuk mengajukan permohonan hapus jurnal oleh dosen :

Nama dosen : 
NIP : 
User name di akun akademik :  
Kode jadwal : 
Tanggal jurnal yang akan dihapus :  
Pertemuan keberapa :
Topik jurnal yang dihapus :
Alasan hapus jurnal : 
